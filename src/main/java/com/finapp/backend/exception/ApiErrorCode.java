...
public enum ApiErrorCode {
    ...
    NAME_INVALID(
            ...
            "Name must contain at least two words with only letters"
    ),

    NAME_UNCHANGED(
            "NAME_UNCHANGED",
            "New name must be different from current one",
            "You must provide a name that is not equal to your current name"
    ),
